...
# bot.add_event_handler(begin)
# bot.add_event_handler(choose_level)
# bot.add_event_handler(confirmed)
# bot.add_event_handler(cards)
# bot.add_event_handler(get_start_cards)
# bot.add_event_handler(create_self_words)
# bot.add_event_handler(start_chat)
# bot.add_event_handler(start_quiz)
# bot.add_event_handler(start_conversation_mode)
# bot.add_event_handler(handle_card_callback)
# bot.add_event_handler(handle_testing_callback)
# bot.add_event_handler(handle_translate_callback)
# bot.add_event_handler(handle_get_cards_callback)
# bot.add_event_handler(handle_topics_callback)
#
# bot.add_event_handler(dialog_with_ellie)
# bot.add_event_handler(handle_testing_answer)
# bot.add_event_handler(handle_review_message)
# bot.add_event_handler(handle_custom_topic_input)
#
# bot.add_event_handler(see_cards)
# bot.add_event_handler(testing_words)
# bot.add_event_handler(choose_other_mode)
#
# bot.add_event_handler(about_me)
# bot.add_event_handler(leave_feedback_prompt)
# bot.add_event_handler(get_my_cards)
# bot.add_event_handler(reviews)
# bot.add_event_handler(change_level)
# bot.add_event_handler(get_back)
# bot.add_event_handler(get_end)
# bot.add_event_handler(change_interests)
#
# bot.add_event_handler(get_fiton)
# bot.add_event_handler(get_delos)
