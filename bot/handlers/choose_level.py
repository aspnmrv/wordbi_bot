...
async def choose_level(event):
    ...
    if await is_expected_steps(user_id, [2, 41, 42]):
        ...
        text = (
            ...
            "1️⃣ Карточки слов 🧩: в этом режиме я сформирую для тебя список слов для изучения на основе "
            "твоих интересов и текущего уровня языка или ты можешь отправить мне свои интересы, а я сформирую на их основе список слов.\n\n"
